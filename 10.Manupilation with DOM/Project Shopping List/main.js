...
function addItem(event) {
  ...
  if (userInput !== "") {
    ...
    list.innerHTML +=
      `<li class="row">
                <input type="checkbox" name="item" ${checked} onclick="switchList(this)" class="col-2">
                <span class="col-6">${userInput}</span>
                <button class="col-1" onclick="deleteItem(this)">X</button>
            </li>`;
